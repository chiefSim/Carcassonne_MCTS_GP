...
class Star2_5(Player):
    ...
    def __init__(self, currentPlayer = 0, Depth = 0, MaxDepth = 1, Alpha = -float('inf'), Beta = float('inf'), ProbingFactor = 5, Chance = None, Init = False):
        super().__init__()
    ...
    def ClonePlayer(self):
        Clone = Star2_5(self.currentPlayer, self.Depth, self.MaxDepth, self.Alpha, self.Beta, self.ProbingFactor, self.Chance, self.Init)
        return Clone
