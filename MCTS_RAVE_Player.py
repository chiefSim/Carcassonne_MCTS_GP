...
class MCTS_RAVEPlayer(Player):
    ...
    def __init__(self, iterations = 1000, timeLimit = 10, isTimeLimited = False, c_param = 4, logs=True):
        super().__init__()
    ...
    def ClonePlayer(self):
        Clone = MCTS_RAVEPlayer(self.iterations, self.timeLimit, self.isTimeLimited)
        return Clone
